...
-- AddForeignKey
ALTER TABLE "advertisement" ADD CONSTRAINT "advertisement_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "company"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
